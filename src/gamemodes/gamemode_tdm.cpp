...
player_team Gamemode_TDMGetWinner()
{
	...
	{
		return (player_team)(team_director | team_player); // this indicates a draw
	}
}
...
edict_t* Gamemode_TDMSpawnPlayer(edict_t* player)
{
	...
	// 
	// Teamflag 1 - Director
	const char* spawn_class_name = "info_player_start_director";

	// Teamflag 2 - Player
	// ignore the warning this is specifically checking for the team and not both
